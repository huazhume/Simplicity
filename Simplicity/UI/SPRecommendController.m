//
//  SPRecommendController.m
//  Simplicity
//
//  Created by xiaobai zhang on 2019/6/4.
...
@implementation SPRecommendController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"SPRecommendCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"SPRecommendCell"];
