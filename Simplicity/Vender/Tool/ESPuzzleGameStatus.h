...
@interface ESPuzzleGameStatus : NSObject <ESGamePathSearchStatus, ESStarGameSearcherStatus>

/// 矩阵阶数
@property (nonatomic, assign) NSInteger matrixOrder;

/// 方块数组，按从上到下，从左到右，顺序排列
@property (nonatomic, strong) NSMutableArray<ESPuzzleGamePiece *> *pieceArray;
